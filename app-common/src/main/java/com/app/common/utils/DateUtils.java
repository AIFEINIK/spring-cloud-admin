...
public class DateUtils {
    ...
    public static Date getEndDateTime(String dateStr) {
        final Date date = parseStringToDate(dateStr, DATE_FORMAT_SHORT);
        LocalDateTime localDateTime = LocalDateTime.ofInstant(Instant.ofEpochMilli(date.getTime()), ZoneId.systemDefault());
        LocalDateTime endOfDay = localDateTime.with(LocalTime.MAX);
        Date d = Date.from(endOfDay.atZone(ZoneId.systemDefault()).toInstant());
...
//        final String curDateTime = getCurDateTime(DATE_FORMAT_COMPACT);
//        System.out.println("curDateTime = " + curDateTime);
//
//        final String s = getEndTime("2019-02-12 12:02:01");
//        System.out.println(s);
        DateUtils.parseStringToDate("2018-04-08",DateUtils.DATE_FORMAT_SHORT);
    }
}
